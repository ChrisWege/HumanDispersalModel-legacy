...
if __name__ == "__main__":
    ...
    input_file = "ehep_auri_13_interstadial.nc"
    path_input = "/data/sfb806/human_mobility_model/konstantin/results/HEP_Heinrich/1st_review/" + input_file
    path_ice = "/data/sfb806/human_mobility_model/data/Ice_mask_alps_mod.nc"
    path_watermask = "/data/sfb806/human_mobility_model/data/topography/watermask_ext_80.nc"
    ...
    path_output = "/data/sfb806/human_mobility_model/christian/Applic_Auri_Grav/Acc_EHEP/glac_mask_mod/"
    
    # Output file name
    file_out_Acc = "Acc_HEP_auri_12_cold.nc"
